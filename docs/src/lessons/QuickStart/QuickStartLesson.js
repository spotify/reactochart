...
export default class QuickStartLesson extends React.Component {
  render() {
    return <Lesson name="Quick Start" componentName="QuickStart">

      <p>
        To get started using Reactochart, first install it using <code>npm</code>:
      </p>
      <pre>
      ...
      <p>
        ...
        future examples, the code on the left side is editable and will update the preview on the right -
        so experiment and see for yourself how things work!
      </p>
