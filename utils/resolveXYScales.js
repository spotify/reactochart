    ...
    _createClass(_class, [{
      ...
      value: function _resolveTickDomain(props, Component, _ref3) {
        ...
        if (_lodash2.default.isFunction(Component.getTickDomain)) {
          var componentTickDomains = Component.getTickDomain(_extends({
      ...
      value: function _resolveMargin(props, Component, _ref4) {
        ...
        if (_lodash2.default.isFunction(Component.getMargin)) {
          var componentMargin = omitNullUndefined(Component.getMargin(_extends({}, props, {
            xScaleType: xScaleType,
            yScaleType: yScaleType,
            xDomain: xDomain,
            yDomain: yDomain,
          ...
          var _$assign2 = _lodash2.default.assign(componentMargin, omitNullUndefined({
            marginTop: marginTop,
      ...
      value: function _resolveSpacing(props, Component, _ref5) {
        ...
        if (_lodash2.default.isFunction(Component.getSpacing)) {
          var componentSpacing = omitNullUndefined(Component.getSpacing(_extends({}, props, {
            xScaleType: xScaleType,
            yScaleType: yScaleType,
            xDomain: xDomain,
            yDomain: yDomain,
          ...
          var _$assign3 = _lodash2.default.assign(componentSpacing, omitNullUndefined({
      ...
      value: function render() {
        ...
        var _resolveTickDomain2 = this._resolveTickDomain(props, ComposedComponent, {
          xScaleType: xScaleType,
          yScaleType: yScaleType,
          xDomain: xDomain,
          yDomain: yDomain,
        ...
        var _$defaults = _lodash2.default.defaults(this._resolveMargin(props, ComposedComponent, {
          xScaleType: xScaleType,
          yScaleType: yScaleType,
          xDomain: xDomain,
          yDomain: yDomain,
        ...
        var _$defaults2 = _lodash2.default.defaults(this._resolveSpacing(props, ComposedComponent, {
          xScaleType: xScaleType,
          yScaleType: yScaleType,
          xDomain: xDomain,
          yDomain: yDomain,
        ...
        scaleOptions = _extends({}, scaleOptions, {
          marginTop: marginTop,
          marginBottom: marginBottom,
          marginLeft: marginLeft,
          marginRight: marginRight,
