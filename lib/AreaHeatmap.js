...
var AreaHeatmap = function (_React$Component) {
  ...
  _createClass(AreaHeatmap, [{
    ...
    value: function getDomain(props) {
      ...
      return {
        x: (0, _d2.extent)(_lodash2.default.flatten([data.map((0, _Data.makeAccessor)(getX)), data.map((0, _Data.makeAccessor)(getXEnd))])),
        y: (0, _d2.extent)(_lodash2.default.flatten([data.map((0, _Data.makeAccessor)(getY)), data.map((0, _Data.makeAccessor)(getYEnd))]))
      };
    }
  }]);
