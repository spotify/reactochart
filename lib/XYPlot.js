...
function getMouseOptions(event, _ref) {
  ...
  var chartSize = (0, _Margin.innerSize)({ width: width, height: height }, { top: marginTop, bottom: marginBottom, left: marginLeft, right: marginRight });
  var xScaleType = (0, _Scale.inferScaleType)(xScale);
  var yScaleType = (0, _Scale.inferScaleType)(yScale);

  var xValue = !_lodash2.default.inRange(innerX, 0, chartSize.width /* + padding.left + padding.right */) ? null : xScaleType === 'ordinal' ? invertPointScale(xScale, innerX) : xScale.invert(innerX);
  var yValue = !_lodash2.default.inRange(innerY, 0, chartSize.height /* + padding.top + padding.bottom */) ? null : yScaleType === 'ordinal' ? invertPointScale(yScale, innerY) : yScale.invert(innerY);

  return { event: event, outerX: outerX, outerY: outerY, innerX: innerX, innerY: innerY, xValue: xValue, yValue: yValue, xScale: xScale, yScale: yScale, marginTop: marginTop, marginBottom: marginBottom, marginLeft: marginLeft, marginRight: marginRight };
}
...
var XYPlot = function (_React$Component) {
  ...
  _createClass(XYPlot, [{
    ...
    value: function render() {
      ...
      var panelSize = (0, _Margin.innerSize)({ width: width, height: height }, { top: marginTop, bottom: marginBottom, left: marginLeft, right: marginRight });
      var chartSize = (0, _Margin.innerSize)(panelSize, { top: spacingTop, bottom: spacingBottom, left: spacingLeft, right: spacingRight });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'g',
          { transform: 'translate(' + (marginLeft + spacingLeft) + ', ' + (marginTop + spacingTop) + ')', className: 'chart-inner' },
          _react2.default.createElement('rect', _extends({ transform: 'translate(' + -spacingLeft + ', ' + -spacingTop + ')', className: 'plot-background' }, panelSize)),
