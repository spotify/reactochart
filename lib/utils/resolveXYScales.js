    ...
    _createClass(_class, [{
      ...
      value: function _resolveScaleType(props, Component) {
        ...
        if (_react2.default.Children.count(props.children)) {
          ...
          var childScaleTypes = mapOverChildren(props.children, this._resolveScaleType);
      ...
      value: function _resolveDomain(props, Component, scaleType) {
        ...
        if (_react2.default.Children.count(props.children)) {
          var childDomains = mapOverChildren(props.children, this._resolveDomain, scaleType);
      ...
      value: function _resolveTickDomain(props, Component, scaleType, domain, scale) {
        ...
        if (_react2.default.Children.count(props.children)) {
          var childTickDomains = mapOverChildren(props.children, this._resolveTickDomain, scaleType, domain, scale);
