...
var ScatterPlot = function (_React$Component) {
  ...
  function ScatterPlot() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ScatterPlot.__proto__ || Object.getPrototypeOf(ScatterPlot)).call.apply(_ref, [this].concat(args))), _this), _this.onMouseEnterPoint = function (e, d) {
      ...
      var _this$props = _this.props,
          ...
          pointClassName = _this$props.pointClassName;
      var pointSymbol = _this.props.pointSymbol;

      var className = 'chart-scatterplot-point ' + (0, _Data.getValue)(pointClassName, d, i);
      var style = (0, _Data.getValue)(pointStyle, d, i);
      ...
      var cx = xScale((0, _Data.getValue)(x, d, i)) + pointOffset[0];
      var cy = yScale((0, _Data.getValue)(y, d, i)) + pointOffset[1];
      ...
      if (pointSymbol.type === 'circle' || pointSymbol.type === 'ellipse') {
        ...
        _lodash2.default.assign(symbolProps, { x: cx, y: cy, style: _extends({ textAnchor: 'middle', dominantBaseline: 'central' }, style) });
      } else {
        _lodash2.default.assign(symbolProps, { x: cx, y: cy, style: _extends({ transform: "translate(-50%, -50%)" }, style) });
      }
  ...
  _createClass(ScatterPlot, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      var shouldUpdate = !(0, _xyPropsEqual2.default)(this.props, nextProps, ['pointStyle']);
      return shouldUpdate;
    }
  }, {
    key: 'render',
