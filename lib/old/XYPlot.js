        ...
        if (shouldMeasureLabels) {
            (function () {
                ...
                var _loop = function _loop() {
                    ...
                    var maxYValWidth = (hasYValLabels ? Math.ceil(d3.max(labelBoxes.yVal, (0, _util.accessor)('width'))) : 0) + yTickAndPadSpace;
                    ...
                    var maxXValHeight = (hasXValLabels ? Math.ceil(d3.max(labelBoxes.xVal, (0, _util.accessor)('height'))) : 0) + xTickAndPadSpace;
